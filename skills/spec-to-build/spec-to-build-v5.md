...
8. **Remind the user to verify.** After writing the build plan, remind the user to run `/build-spec` to execute it — that skill handles building and post-build verification against the spec.
