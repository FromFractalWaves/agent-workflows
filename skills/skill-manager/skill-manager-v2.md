...
5. **Write the initial changelog entry.** Create `~/projects/agent-workflows/changelog/[name]/v1/` and write:
   ...
   **`reasoning.md`:**
   ...
   Optionally, if the user provided planning notes or an outline before creation, also save them as `outline.md` and/or `idea.md` in the same directory.
...
6. **Write the changelog entry.** Create `~/projects/agent-workflows/changelog/[name]/v[N]/` and write:
   ...
   **`reasoning.md`:**
   ...
   Optionally, if the user provided planning notes, also save as `outline.md` and/or `idea.md` in the same directory.
...
6. **Write the changelog entry.** Create `~/projects/agent-workflows/changelog/[name]/v[N]/` and write `diff.md` and `reasoning.md` using the same formats as update mode. Optionally include `outline.md` or `idea.md`.
...
| Changelog entries | `~/projects/agent-workflows/changelog/[name]/v[N]/` |
